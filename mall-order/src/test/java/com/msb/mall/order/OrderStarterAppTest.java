...
class OrderStarterAppTest {
    ...
    void sendMSG1() throws Exception{
        ...
        // 设置NameServer的地址
        producer.setNamesrvAddr("rocketmq-namesrv.sangomall.svc.cluster.local.:9876");
        // 启动Producer实例
        producer.start();
        for (int i = 0; i < 20; i++) {
    ...
    public void consumerMsg1() throws Exception{
        ...
        // 设置NameServer的地址
        consumer.setNamesrvAddr("rocketmq-namesrv.sangomall.svc.cluster.local.:9876");
