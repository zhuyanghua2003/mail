...
-- ----------------------------
INSERT INTO `ums_member` VALUES (1, 1, 'admin1', '$2a$10$sdhTcdqfcEB.qdAXDkiJcO6JnDfpX2OXVj3yhgH1kf8LNRDnz/fq.', '喵喵喵', '15005898880', NULL, '1', 1, '2025-12-17', '11', '11', '11', 111, 11, 11, 1, '2025-12-08 23:23:52', NULL, NULL, NULL);
INSERT INTO `ums_member` VALUES (2, 1, '11', NULL, '用户7481938854', NULL, NULL, '1', 1, NULL, '1', '1', '1', 1, 1, 1, 1, '2025-12-17 23:34:03', '7481938854', '2.00IF92KIjoV1CB63a1c46634wsQuEC', '157679999');
...
CREATE TABLE `ums_member_level`  (
  ...
  `note` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '备注',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 6 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '会员等级' ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of ums_member_level
-- ----------------------------
INSERT INTO `ums_member_level` VALUES (1, '普通会员', 0, 1, 299.0000, 1, 0, 1, 0, '普通会员');
INSERT INTO `ums_member_level` VALUES (2, '青铜会员', 500, 0, 200.0000, 2, 1, 1, 0, '青铜会员');
INSERT INTO `ums_member_level` VALUES (3, '白银会员', 999, 0, 100.0000, 3, 1, 1, 1, '白银会员');
INSERT INTO `ums_member_level` VALUES (4, '黄金会员', 2000, 0, 100.0000, 5, 1, 1, 1, '黄金会员');
INSERT INTO `ums_member_level` VALUES (5, '钻石会员', 5000, 0, 99.0000, 10, 1, 1, 1, '钻石会员');
...
CREATE TABLE `ums_member_receive_address`  (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 2 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '会员收货地址' ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of ums_member_receive_address
-- ----------------------------
INSERT INTO `ums_member_receive_address` VALUES (1, 2, '谷雨', '15005898880', '1', '1', '1', '1', '1', '1', 1);
