...
CREATE TABLE `pms_attr`  (
  `attr_id` bigint(20) NOT NULL AUTO_INCREMENT COMMENT '????id',
  `attr_name` char(30) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL DEFAULT NULL COMMENT '??????',
  `search_type` tinyint(4) NULL DEFAULT NULL COMMENT '?Ƿ???Ҫ????[0-????Ҫ??1-??Ҫ]',
  `icon` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL DEFAULT NULL COMMENT '????ͼ?',
  `value_select` char(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL DEFAULT NULL COMMENT '??ѡֵ?б?[?ö??ŷָ',
  `attr_type` tinyint(4) NULL DEFAULT NULL COMMENT '????????[0-???????ԣ?1-???????ԣ?2-???????????????ǻ???????]',
  `enable` bigint(20) NULL DEFAULT NULL COMMENT '????״̬[0 - ???ã?1 - ????]',
  `catelog_id` bigint(20) NULL DEFAULT NULL COMMENT '???????',
  `show_desc` tinyint(4) NULL DEFAULT NULL COMMENT '????չʾ???Ƿ?չʾ?ڽ????ϣ?0-?? 1-?ǡ?????sku????Ȼ???Ե???',
  PRIMARY KEY (`attr_id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 33 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_unicode_ci COMMENT = '??Ʒ?' ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of pms_attr
-- ----------------------------
INSERT INTO `pms_attr` VALUES (1, '上市年份', 1, '1212', '2021;2022', 1, 1, 225, 0);
INSERT INTO `pms_attr` VALUES (2, '入网型号', 1, 'T', 'XXXT', 1, 1, 225, 0);
INSERT INTO `pms_attr` VALUES (3, '上市年份', 1, 'E', '2021;2022;舞舞舞', 1, 1, 225, 0);
INSERT INTO `pms_attr` VALUES (5, '尺寸', 0, '111', '啊洒洒水;111;222;333', 0, 1, 225, 0);
INSERT INTO `pms_attr` VALUES (7, '选择颜色', 0, 'swwd', '土豪金;黑色;绿色;秘银色', 0, 1, 225, 0);
INSERT INTO `pms_attr` VALUES (10, '上市月份', 1, '11', '12;11;9;8;7;6', 1, 1, 225, 0);
INSERT INTO `pms_attr` VALUES (11, '首销日期', 1, '11', '10.01;121.11', 1, 1, 225, 0);
INSERT INTO `pms_attr` VALUES (12, '上市年份', 0, '11', '1212', 1, 1, 225, 0);
INSERT INTO `pms_attr` VALUES (13, '111111', 0, '1111', '1111', 1, 1, 225, 0);
INSERT INTO `pms_attr` VALUES (14, '222222', 0, '22222', '2222', 1, 1, 225, 0);
INSERT INTO `pms_attr` VALUES (15, '444444', 0, '444', '444', 1, 1, 225, 0);
INSERT INTO `pms_attr` VALUES (16, '入网型号', 0, '1', 'NOH-AL00', 1, 1, 225, 0);
INSERT INTO `pms_attr` VALUES (17, '产品名称', 0, '1', '华为MATE40PRO;小米;苹果;OPPO', 1, 1, 225, 0);
INSERT INTO `pms_attr` VALUES (18, '机身宽度', 0, '1', '75;76', 1, 1, 225, 0);
INSERT INTO `pms_attr` VALUES (19, '机身重量', 0, '1', '212g', 1, 1, 225, 0);
INSERT INTO `pms_attr` VALUES (20, '机身长度', 0, '1', '162.9mm', 1, 1, 225, 0);
INSERT INTO `pms_attr` VALUES (21, 'CPU品牌', 0, '1', '华为;小米;苹果;OPPO', 1, 1, 225, 0);
INSERT INTO `pms_attr` VALUES (22, 'CPU型号', 0, '1', 'Mali-G78', 1, 1, 225, 0);
INSERT INTO `pms_attr` VALUES (23, '材质类型', 0, '1', 'OLED', 1, 1, 225, 0);
INSERT INTO `pms_attr` VALUES (24, '后置摄像头光圈', 0, '1', 'f/1.9', 1, 1, 225, 0);
INSERT INTO `pms_attr` VALUES (25, '闪光灯', 0, '1', 'LED', 1, 1, 225, 0);
INSERT INTO `pms_attr` VALUES (26, '闪光灯', 0, '1', '其他', 1, 1, 225, 0);
INSERT INTO `pms_attr` VALUES (27, '屏幕材质类型', 0, '1', 'OLED', 1, 1, 225, 0);
INSERT INTO `pms_attr` VALUES (28, '屏幕尺寸', 0, '1', '其他', 1, 1, 225, 0);
INSERT INTO `pms_attr` VALUES (29, '选择版本', 0, '1', '128G;256G;512G', 0, 1, 225, 0);
INSERT INTO `pms_attr` VALUES (30, '购买方式', 0, '1', '官方标配', 0, 1, 225, 0);
INSERT INTO `pms_attr` VALUES (31, '套装', 0, '1', '优惠套装1;优惠套装2;优惠套装3;优惠套装4;优惠套装5', 0, 1, 225, 0);
INSERT INTO `pms_attr` VALUES (32, '原厂服务', 0, '1', '一年碎屏保499', 0, 1, 225, 0);
...
CREATE TABLE `pms_attr_attrgroup_relation`  (
  ...
  `attr_id` bigint(20) NULL DEFAULT NULL COMMENT '????id',
  `attr_group_id` bigint(20) NULL DEFAULT NULL COMMENT '???Է???id',
  `attr_sort` int(11) NULL DEFAULT NULL COMMENT '???????????',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 29 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_unicode_ci COMMENT = '????&???Է???????' ROW_FORMAT = Dynamic;
...
INSERT INTO `pms_attr_attrgroup_relation` VALUES (8, 11, 2, NULL);
INSERT INTO `pms_attr_attrgroup_relation` VALUES (13, 10, 1, NULL);
INSERT INTO `pms_attr_attrgroup_relation` VALUES (14, 16, 1, NULL);
INSERT INTO `pms_attr_attrgroup_relation` VALUES (15, 17, 1, NULL);
INSERT INTO `pms_attr_attrgroup_relation` VALUES (16, 18, 2, NULL);
INSERT INTO `pms_attr_attrgroup_relation` VALUES (17, 19, 2, NULL);
INSERT INTO `pms_attr_attrgroup_relation` VALUES (18, 20, 2, NULL);
INSERT INTO `pms_attr_attrgroup_relation` VALUES (19, 21, 3, NULL);
INSERT INTO `pms_attr_attrgroup_relation` VALUES (20, 22, 3, NULL);
INSERT INTO `pms_attr_attrgroup_relation` VALUES (21, 23, 9, NULL);
INSERT INTO `pms_attr_attrgroup_relation` VALUES (22, 24, 11, NULL);
INSERT INTO `pms_attr_attrgroup_relation` VALUES (23, 25, 11, NULL);
INSERT INTO `pms_attr_attrgroup_relation` VALUES (24, 26, 10, NULL);
INSERT INTO `pms_attr_attrgroup_relation` VALUES (25, 27, 9, NULL);
INSERT INTO `pms_attr_attrgroup_relation` VALUES (26, 28, 9, NULL);
INSERT INTO `pms_attr_attrgroup_relation` VALUES (27, 1, NULL, NULL);
INSERT INTO `pms_attr_attrgroup_relation` VALUES (28, 2, NULL, NULL);
...
CREATE TABLE `pms_attr_group`  (
  `attr_group_id` bigint(20) NOT NULL AUTO_INCREMENT COMMENT '????id',
  `attr_group_name` char(20) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL DEFAULT NULL COMMENT '????',
  `sort` int(11) NULL DEFAULT NULL COMMENT '???',
  `descript` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL DEFAULT NULL COMMENT '????',
  `icon` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL DEFAULT NULL COMMENT '??ͼ?',
  `catelog_id` bigint(20) NULL DEFAULT NULL COMMENT '????????id',
  PRIMARY KEY (`attr_group_id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 12 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_unicode_ci COMMENT = '???Է??' ROW_FORMAT = Dynamic;
...
INSERT INTO `pms_attr_group` VALUES (3, '主芯片', 3, '3', '3', 225);
INSERT INTO `pms_attr_group` VALUES (4, 'aa', 1, '1', '1', 111);
INSERT INTO `pms_attr_group` VALUES (5, '225', 1, '1', '1', 1);
INSERT INTO `pms_attr_group` VALUES (9, '屏幕', 4, '屏幕', '1', 225);
INSERT INTO `pms_attr_group` VALUES (10, '前置摄像头', 5, '前置摄像头', '1', 225);
INSERT INTO `pms_attr_group` VALUES (11, '后置摄像头', 6, '1', '1', 225);
...
CREATE TABLE `pms_brand`  (
  `brand_id` bigint(20) NOT NULL AUTO_INCREMENT COMMENT 'Ʒ??id',
  `name` char(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL DEFAULT NULL COMMENT 'Ʒ????',
  `logo` varchar(2000) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL DEFAULT NULL COMMENT 'Ʒ??logo??ַ',
  `descript` longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL COMMENT '???',
  `show_status` tinyint(4) NULL DEFAULT NULL COMMENT '??ʾ״̬[0-????ʾ??1-??ʾ]',
  `first_letter` char(1) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL DEFAULT NULL COMMENT '????????ĸ',
  `sort` int(11) NULL DEFAULT NULL COMMENT '???',
  PRIMARY KEY (`brand_id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 23 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_unicode_ci COMMENT = 'Ʒ?' ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of pms_brand
-- ----------------------------
INSERT INTO `pms_brand` VALUES (19, '华为', 'https://msb-mall-zyh2.oss-cn-shanghai.aliyuncs.com/2025-11-23/3195cb73-ee81-44bf-8312-3600da82091f_QQ浏览器截图20241209170221.png', '华为', 1, 'H', 1);
INSERT INTO `pms_brand` VALUES (20, '小米', 'https://msb-mall-zyh2.oss-cn-shanghai.aliyuncs.com/2025-11-23/866b2205-fad6-4945-8fba-ce2f1af9e3a6_QQ浏览器截图20241209171153.png', '小米', 1, 'X', 2);
INSERT INTO `pms_brand` VALUES (21, 'OPPO', 'https://msb-mall-zyh2.oss-cn-shanghai.aliyuncs.com/2025-11-23/caa49e24-8c6b-4199-8b2a-b28ef9a4c384_QQ浏览器截图20241209171434.png', 'OPPO', 1, 'O', 3);
INSERT INTO `pms_brand` VALUES (22, '苹果', 'https://msb-mall-zyh2.oss-cn-shanghai.aliyuncs.com/2025-11-23/487172a9-f532-4345-8754-356c6607251d_QQ浏览器截图20241209171346.png', '苹果', 1, 'P', 4);
...
CREATE TABLE `pms_category`  (
  ...
  `parent_cid` bigint(20) NOT NULL COMMENT '父分类id',
  ...
  PRIMARY KEY (`cat_id`, `parent_cid`) USING BTREE
...
INSERT INTO `pms_category` VALUES (2, '手机', 0, 1, 1, 0, '333', NULL, 0);
...
INSERT INTO `pms_category` VALUES (22, '电子书刊', 1, 2, 1, 1, NULL, NULL, 0);
...
INSERT INTO `pms_category` VALUES (1431, 'dsa323', 1, 2, 1, 12, NULL, NULL, NULL);
...
CREATE TABLE `pms_category_brand_relation`  (
  ...
  `brand_id` bigint(20) NULL DEFAULT NULL COMMENT 'Ʒ??id',
  `catelog_id` bigint(20) NULL DEFAULT NULL COMMENT '????id',
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 20 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_unicode_ci COMMENT = 'Ʒ?Ʒ???????' ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of pms_category_brand_relation
-- ----------------------------
INSERT INTO `pms_category_brand_relation` VALUES (11, 1, 413, '小米', '台灯');
INSERT INTO `pms_category_brand_relation` VALUES (12, 1, 265, '小米', '油烟机');
INSERT INTO `pms_category_brand_relation` VALUES (13, 18, 227, '啊娃娃', '合约机');
INSERT INTO `pms_category_brand_relation` VALUES (16, 21, 227, 'OPPO', '合约机');
INSERT INTO `pms_category_brand_relation` VALUES (18, 19, 225, '华为', '手机');
INSERT INTO `pms_category_brand_relation` VALUES (19, 20, 225, '小米', '手机');
...
CREATE TABLE `pms_comment_replay`  (
  ...
  `reply_id` bigint(20) NULL DEFAULT NULL COMMENT '?ظ?id',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 1 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_unicode_ci COMMENT = '??Ʒ???ۻظ???ϵ' ROW_FORMAT = Dynamic;
...
CREATE TABLE `pms_product_attr_value`  (
  `id` bigint(20) NOT NULL AUTO_INCREMENT COMMENT 'id',
  `spu_id` bigint(20) NULL DEFAULT NULL COMMENT '??Ʒid',
  `attr_id` bigint(20) NULL DEFAULT NULL COMMENT '????id',
  `attr_name` varchar(200) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL DEFAULT NULL COMMENT '??????',
  `attr_value` varchar(200) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL DEFAULT NULL COMMENT '????ֵ',
  `attr_sort` int(11) NULL DEFAULT NULL COMMENT '˳?',
  `quick_show` tinyint(4) NULL DEFAULT NULL COMMENT '????չʾ???Ƿ?չʾ?ڽ????ϣ?0-?? 1-?ǡ?',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 193 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_unicode_ci COMMENT = 'spu????ֵ' ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of pms_product_attr_value
-- ----------------------------
INSERT INTO `pms_product_attr_value` VALUES (81, 7, 3, '上市年份', '2021', NULL, 0);
INSERT INTO `pms_product_attr_value` VALUES (82, 7, 10, '上市月份', '12', NULL, 0);
INSERT INTO `pms_product_attr_value` VALUES (83, 7, 16, '入网型号', 'NOH-AL00', NULL, 0);
INSERT INTO `pms_product_attr_value` VALUES (84, 7, 17, '产品名称', '华为MATE40PRO', NULL, 0);
INSERT INTO `pms_product_attr_value` VALUES (85, 7, 11, '首销日期', '10.01', NULL, 0);
INSERT INTO `pms_product_attr_value` VALUES (86, 7, 18, '机身宽度', '75', NULL, 0);
INSERT INTO `pms_product_attr_value` VALUES (87, 7, 19, '机身重量', '212g', NULL, 0);
INSERT INTO `pms_product_attr_value` VALUES (88, 7, 20, '机身长度', '162.9mm', NULL, 0);
INSERT INTO `pms_product_attr_value` VALUES (89, 7, 21, 'CPU品牌', '华为', NULL, 0);
INSERT INTO `pms_product_attr_value` VALUES (90, 7, 22, 'CPU型号', 'Mali-G78', NULL, 0);
INSERT INTO `pms_product_attr_value` VALUES (91, 7, 23, '材质类型', 'OLED', NULL, 0);
INSERT INTO `pms_product_attr_value` VALUES (92, 7, 27, '屏幕材质类型', 'OLED', NULL, 0);
INSERT INTO `pms_product_attr_value` VALUES (93, 7, 28, '屏幕尺寸', '其他', NULL, 0);
INSERT INTO `pms_product_attr_value` VALUES (94, 7, 26, '闪光灯', '其他', NULL, 0);
INSERT INTO `pms_product_attr_value` VALUES (95, 7, 24, '后置摄像头光圈', 'f/1.9', NULL, 0);
INSERT INTO `pms_product_attr_value` VALUES (96, 7, 25, '闪光灯', 'LED', NULL, 0);
INSERT INTO `pms_product_attr_value` VALUES (97, 10, 3, '上市年份', '2021', NULL, 0);
INSERT INTO `pms_product_attr_value` VALUES (98, 10, 10, '上市月份', '12', NULL, 0);
INSERT INTO `pms_product_attr_value` VALUES (99, 10, 16, '入网型号', 'NOH-AL00', NULL, 0);
INSERT INTO `pms_product_attr_value` VALUES (100, 10, 17, '产品名称', '华为MATE40PRO', NULL, 0);
INSERT INTO `pms_product_attr_value` VALUES (101, 10, 11, '首销日期', '10.01', NULL, 0);
INSERT INTO `pms_product_attr_value` VALUES (102, 10, 18, '机身宽度', '75', NULL, 0);
INSERT INTO `pms_product_attr_value` VALUES (103, 10, 19, '机身重量', '212g', NULL, 0);
INSERT INTO `pms_product_attr_value` VALUES (104, 10, 20, '机身长度', '162.9mm', NULL, 0);
INSERT INTO `pms_product_attr_value` VALUES (105, 10, 21, 'CPU品牌', '小米', NULL, 0);
INSERT INTO `pms_product_attr_value` VALUES (106, 10, 22, 'CPU型号', 'Mali-G78', NULL, 0);
INSERT INTO `pms_product_attr_value` VALUES (107, 10, 23, '材质类型', 'OLED', NULL, 0);
INSERT INTO `pms_product_attr_value` VALUES (108, 10, 27, '屏幕材质类型', 'OLED', NULL, 0);
INSERT INTO `pms_product_attr_value` VALUES (109, 10, 28, '屏幕尺寸', '其他', NULL, 0);
INSERT INTO `pms_product_attr_value` VALUES (110, 10, 26, '闪光灯', '其他', NULL, 0);
INSERT INTO `pms_product_attr_value` VALUES (111, 10, 24, '后置摄像头光圈', 'f/1.9', NULL, 0);
INSERT INTO `pms_product_attr_value` VALUES (112, 10, 25, '闪光灯', 'LED', NULL, 0);
INSERT INTO `pms_product_attr_value` VALUES (113, 11, 3, '上市年份', '2021', NULL, 0);
INSERT INTO `pms_product_attr_value` VALUES (114, 11, 10, '上市月份', '12', NULL, 0);
INSERT INTO `pms_product_attr_value` VALUES (115, 11, 16, '入网型号', 'NOH-AL00', NULL, 0);
INSERT INTO `pms_product_attr_value` VALUES (116, 11, 17, '产品名称', '华为MATE40PRO', NULL, 0);
INSERT INTO `pms_product_attr_value` VALUES (117, 11, 11, '首销日期', '10.01', NULL, 0);
INSERT INTO `pms_product_attr_value` VALUES (118, 11, 18, '机身宽度', '75', NULL, 0);
INSERT INTO `pms_product_attr_value` VALUES (119, 11, 19, '机身重量', '212g', NULL, 0);
INSERT INTO `pms_product_attr_value` VALUES (120, 11, 20, '机身长度', '162.9mm', NULL, 0);
INSERT INTO `pms_product_attr_value` VALUES (121, 11, 21, 'CPU品牌', '华为', NULL, 0);
INSERT INTO `pms_product_attr_value` VALUES (122, 11, 22, 'CPU型号', 'Mali-G78', NULL, 0);
INSERT INTO `pms_product_attr_value` VALUES (123, 11, 23, '材质类型', 'OLED', NULL, 0);
INSERT INTO `pms_product_attr_value` VALUES (124, 11, 27, '屏幕材质类型', 'OLED', NULL, 0);
INSERT INTO `pms_product_attr_value` VALUES (125, 11, 28, '屏幕尺寸', '其他', NULL, 0);
INSERT INTO `pms_product_attr_value` VALUES (126, 11, 26, '闪光灯', '其他', NULL, 0);
INSERT INTO `pms_product_attr_value` VALUES (127, 11, 24, '后置摄像头光圈', 'f/1.9', NULL, 0);
INSERT INTO `pms_product_attr_value` VALUES (128, 11, 25, '闪光灯', 'LED', NULL, 0);
INSERT INTO `pms_product_attr_value` VALUES (129, 12, 3, '上市年份', '2022', NULL, 0);
INSERT INTO `pms_product_attr_value` VALUES (130, 12, 10, '上市月份', '11', NULL, 0);
INSERT INTO `pms_product_attr_value` VALUES (131, 12, 16, '入网型号', 'NOH-AL00', NULL, 0);
INSERT INTO `pms_product_attr_value` VALUES (132, 12, 17, '产品名称', '小米', NULL, 0);
INSERT INTO `pms_product_attr_value` VALUES (133, 12, 11, '首销日期', '10.01', NULL, 0);
INSERT INTO `pms_product_attr_value` VALUES (134, 12, 18, '机身宽度', '75', NULL, 0);
INSERT INTO `pms_product_attr_value` VALUES (135, 12, 19, '机身重量', '212g', NULL, 0);
INSERT INTO `pms_product_attr_value` VALUES (136, 12, 20, '机身长度', '162.9mm', NULL, 0);
INSERT INTO `pms_product_attr_value` VALUES (137, 12, 21, 'CPU品牌', '小米', NULL, 0);
INSERT INTO `pms_product_attr_value` VALUES (138, 12, 22, 'CPU型号', 'Mali-G78', NULL, 0);
INSERT INTO `pms_product_attr_value` VALUES (139, 12, 23, '材质类型', 'OLED', NULL, 0);
INSERT INTO `pms_product_attr_value` VALUES (140, 12, 27, '屏幕材质类型', 'OLED', NULL, 0);
INSERT INTO `pms_product_attr_value` VALUES (141, 12, 28, '屏幕尺寸', '其他', NULL, 0);
INSERT INTO `pms_product_attr_value` VALUES (142, 12, 26, '闪光灯', '其他', NULL, 0);
INSERT INTO `pms_product_attr_value` VALUES (143, 12, 24, '后置摄像头光圈', 'f/1.9', NULL, 0);
INSERT INTO `pms_product_attr_value` VALUES (144, 12, 25, '闪光灯', 'LED', NULL, 0);
INSERT INTO `pms_product_attr_value` VALUES (145, 13, 3, '上市年份', '2021', NULL, 1);
INSERT INTO `pms_product_attr_value` VALUES (146, 13, 10, '上市月份', '12', NULL, 1);
INSERT INTO `pms_product_attr_value` VALUES (147, 13, 16, '入网型号', 'NOH-AL00', NULL, 1);
INSERT INTO `pms_product_attr_value` VALUES (148, 13, 17, '产品名称', '华为MATE40PRO', NULL, 1);
INSERT INTO `pms_product_attr_value` VALUES (149, 13, 11, '首销日期', '10.01', NULL, 1);
INSERT INTO `pms_product_attr_value` VALUES (150, 13, 18, '机身宽度', '75', NULL, 1);
INSERT INTO `pms_product_attr_value` VALUES (151, 13, 19, '机身重量', '212g', NULL, 1);
INSERT INTO `pms_product_attr_value` VALUES (152, 13, 20, '机身长度', '162.9mm', NULL, 1);
INSERT INTO `pms_product_attr_value` VALUES (153, 13, 21, 'CPU品牌', '华为', NULL, 1);
INSERT INTO `pms_product_attr_value` VALUES (154, 13, 22, 'CPU型号', 'Mali-G78', NULL, 1);
INSERT INTO `pms_product_attr_value` VALUES (155, 13, 23, '材质类型', 'OLED', NULL, 1);
INSERT INTO `pms_product_attr_value` VALUES (156, 13, 27, '屏幕材质类型', 'OLED', NULL, 1);
INSERT INTO `pms_product_attr_value` VALUES (157, 13, 28, '屏幕尺寸', '其他', NULL, 1);
INSERT INTO `pms_product_attr_value` VALUES (158, 13, 26, '闪光灯', '其他', NULL, 0);
INSERT INTO `pms_product_attr_value` VALUES (159, 13, 24, '后置摄像头光圈', 'f/1.9', NULL, 0);
INSERT INTO `pms_product_attr_value` VALUES (160, 13, 25, '闪光灯', 'LED', NULL, 0);
INSERT INTO `pms_product_attr_value` VALUES (161, 14, 3, '上市年份', '2021', NULL, 1);
INSERT INTO `pms_product_attr_value` VALUES (162, 14, 10, '上市月份', '12', NULL, 1);
INSERT INTO `pms_product_attr_value` VALUES (163, 14, 16, '入网型号', 'NOH-AL00', NULL, 1);
INSERT INTO `pms_product_attr_value` VALUES (164, 14, 17, '产品名称', '华为MATE40PRO', NULL, 1);
INSERT INTO `pms_product_attr_value` VALUES (165, 14, 11, '首销日期', '10.01', NULL, 0);
INSERT INTO `pms_product_attr_value` VALUES (166, 14, 18, '机身宽度', '75', NULL, 0);
INSERT INTO `pms_product_attr_value` VALUES (167, 14, 19, '机身重量', '212g', NULL, 0);
INSERT INTO `pms_product_attr_value` VALUES (168, 14, 20, '机身长度', '162.9mm', NULL, 0);
INSERT INTO `pms_product_attr_value` VALUES (169, 14, 21, 'CPU品牌', '华为', NULL, 0);
INSERT INTO `pms_product_attr_value` VALUES (170, 14, 22, 'CPU型号', 'Mali-G78', NULL, 0);
INSERT INTO `pms_product_attr_value` VALUES (171, 14, 23, '材质类型', 'OLED', NULL, 0);
INSERT INTO `pms_product_attr_value` VALUES (172, 14, 27, '屏幕材质类型', 'OLED', NULL, 0);
INSERT INTO `pms_product_attr_value` VALUES (173, 14, 28, '屏幕尺寸', '其他', NULL, 0);
INSERT INTO `pms_product_attr_value` VALUES (174, 14, 26, '闪光灯', '其他', NULL, 0);
INSERT INTO `pms_product_attr_value` VALUES (175, 14, 24, '后置摄像头光圈', 'f/1.9', NULL, 0);
INSERT INTO `pms_product_attr_value` VALUES (176, 14, 25, '闪光灯', 'LED', NULL, 0);
INSERT INTO `pms_product_attr_value` VALUES (177, 15, 3, '上市年份', '2021', NULL, 1);
INSERT INTO `pms_product_attr_value` VALUES (178, 15, 10, '上市月份', '12', NULL, 1);
INSERT INTO `pms_product_attr_value` VALUES (179, 15, 16, '入网型号', 'NOH-AL00', NULL, 1);
INSERT INTO `pms_product_attr_value` VALUES (180, 15, 17, '产品名称', '华为MATE40PRO', NULL, 1);
INSERT INTO `pms_product_attr_value` VALUES (181, 15, 11, '首销日期', '10.01', NULL, 0);
INSERT INTO `pms_product_attr_value` VALUES (182, 15, 18, '机身宽度', '75', NULL, 0);
INSERT INTO `pms_product_attr_value` VALUES (183, 15, 19, '机身重量', '212g', NULL, 0);
INSERT INTO `pms_product_attr_value` VALUES (184, 15, 20, '机身长度', '162.9mm', NULL, 0);
INSERT INTO `pms_product_attr_value` VALUES (185, 15, 21, 'CPU品牌', '华为', NULL, 0);
INSERT INTO `pms_product_attr_value` VALUES (186, 15, 22, 'CPU型号', 'Mali-G78', NULL, 0);
INSERT INTO `pms_product_attr_value` VALUES (187, 15, 23, '材质类型', 'OLED', NULL, 0);
INSERT INTO `pms_product_attr_value` VALUES (188, 15, 27, '屏幕材质类型', 'OLED', NULL, 0);
INSERT INTO `pms_product_attr_value` VALUES (189, 15, 28, '屏幕尺寸', '其他', NULL, 0);
INSERT INTO `pms_product_attr_value` VALUES (190, 15, 26, '闪光灯', '其他', NULL, 0);
INSERT INTO `pms_product_attr_value` VALUES (191, 15, 24, '后置摄像头光圈', 'f/1.9', NULL, 0);
INSERT INTO `pms_product_attr_value` VALUES (192, 15, 25, '闪光灯', 'LED', NULL, 0);
...
CREATE TABLE `pms_sku_images`  (
  ...
  `img_url` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL DEFAULT NULL COMMENT 'ͼƬ??ַ',
  `img_sort` int(11) NULL DEFAULT NULL COMMENT '???',
  `default_img` int(11) NULL DEFAULT NULL COMMENT 'Ĭ??ͼ[0 - ????Ĭ??ͼ??1 - ??Ĭ??ͼ]',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 16 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_unicode_ci COMMENT = 'skuͼƬ' ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of pms_sku_images
-- ----------------------------
INSERT INTO `pms_sku_images` VALUES (6, 6, 'https://msb-mall-zyh2.oss-cn-shanghai.aliyuncs.com/2025-11-26//af2815f3-1094-4722-8ac0-6e1224029c23_QQ浏览器截图20241209170221.png', NULL, 0);
INSERT INTO `pms_sku_images` VALUES (7, 7, 'https://msb-mall-zyh2.oss-cn-shanghai.aliyuncs.com/2025-11-26//af2815f3-1094-4722-8ac0-6e1224029c23_QQ浏览器截图20241209170221.png', NULL, 0);
INSERT INTO `pms_sku_images` VALUES (8, 8, 'https://msb-mall-zyh2.oss-cn-shanghai.aliyuncs.com/2025-11-26//af2815f3-1094-4722-8ac0-6e1224029c23_QQ浏览器截图20241209170221.png', NULL, 0);
INSERT INTO `pms_sku_images` VALUES (9, 9, 'https://msb-mall-zyh2.oss-cn-shanghai.aliyuncs.com/2025-11-26//af2815f3-1094-4722-8ac0-6e1224029c23_QQ浏览器截图20241209170221.png', NULL, 0);
INSERT INTO `pms_sku_images` VALUES (10, 10, 'https://msb-mall-zyh2.oss-cn-shanghai.aliyuncs.com/2025-11-26//af2815f3-1094-4722-8ac0-6e1224029c23_QQ浏览器截图20241209170221.png', NULL, 0);
INSERT INTO `pms_sku_images` VALUES (11, 11, 'https://msb-mall-zyh2.oss-cn-shanghai.aliyuncs.com/2025-11-26//af2815f3-1094-4722-8ac0-6e1224029c23_QQ浏览器截图20241209170221.png', NULL, 0);
INSERT INTO `pms_sku_images` VALUES (12, 14, 'https://msb-mall-zyh2.oss-cn-shanghai.aliyuncs.com/2025-11-26//a9a3d754-779e-4145-8641-50ecd6a583ce_QQ浏览器截图20241209170221.png', NULL, 1);
INSERT INTO `pms_sku_images` VALUES (13, 15, 'https://msb-mall-zyh2.oss-cn-shanghai.aliyuncs.com/2025-12-04//903c8e1c-1fda-4423-8775-86bc8153fa44_QQ浏览器截图20241209171153.png', NULL, 1);
INSERT INTO `pms_sku_images` VALUES (14, 17, 'https://msb-mall-zyh2.oss-cn-shanghai.aliyuncs.com/2025-12-04//15d6f03b-b7b7-4758-891e-6fe10f2e9a18_QQ浏览器截图20241209170221.png', NULL, 1);
INSERT INTO `pms_sku_images` VALUES (15, 18, 'https://msb-mall-zyh2.oss-cn-shanghai.aliyuncs.com/2025-12-04//f4b4ce33-e470-4275-80b8-5a6f116dcb8e_QQ浏览器截图20241209170221.png', NULL, 1);
...
CREATE TABLE `pms_sku_info`  (
  ...
  `sku_name` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL DEFAULT NULL COMMENT 'sku???',
  `sku_desc` varchar(2000) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL DEFAULT NULL COMMENT 'sku????????',
  `catalog_id` bigint(20) NULL DEFAULT NULL COMMENT '????????id',
  `brand_id` bigint(20) NULL DEFAULT NULL COMMENT 'Ʒ??id',
  `sku_default_img` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL DEFAULT NULL COMMENT 'Ĭ??ͼƬ',
  `sku_title` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL DEFAULT NULL COMMENT '???',
  `sku_subtitle` varchar(2000) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL DEFAULT NULL COMMENT '?????',
  `price` decimal(18, 4) NULL DEFAULT NULL COMMENT '?۸',
  `sale_count` bigint(20) NULL DEFAULT NULL COMMENT '????',
  PRIMARY KEY (`sku_id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 19 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_unicode_ci COMMENT = 'sku??Ϣ' ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of pms_sku_info
-- ----------------------------
INSERT INTO `pms_sku_info` VALUES (6, 7, '华为 MATE ', NULL, 225, 19, '', '华为 MATE 111 土豪金 512G 官方标配 优惠套装1 一年碎屏保499', 'XXX', 6000.0000, 0);
INSERT INTO `pms_sku_info` VALUES (7, 7, '华为 MATE ', NULL, 225, 19, '', '华为 MATE 111 土豪金 256G 官方标配 优惠套装1 一年碎屏保499', 'XXX', 5000.0000, 0);
INSERT INTO `pms_sku_info` VALUES (8, 7, '华为 MATE ', NULL, 225, 19, '', '华为 MATE 111 黑色 512G 官方标配 优惠套装1 一年碎屏保499', 'XXX', 6000.0000, 0);
INSERT INTO `pms_sku_info` VALUES (9, 7, '华华为 MATE ', NULL, 225, 19, '', '华为 MATE 111 黑色 256G 官方标配 优惠套装1 一年碎屏保499', 'XXX', 5000.0000, 0);
INSERT INTO `pms_sku_info` VALUES (10, 7, '华为 MATE ', NULL, 225, 19, '', '华为 MATE 111 绿色 512G 官方标配 优惠套装1 一年碎屏保499', 'XXX', 6000.0000, 0);
INSERT INTO `pms_sku_info` VALUES (11, 7, '华为 MATE ', NULL, 225, 19, '', '华为 MATE 111 绿色 256G 官方标配 优惠套装1 一年碎屏保499', 'XXX', 5000.0000, 0);
INSERT INTO `pms_sku_info` VALUES (12, 10, '小米12 Pro 222 黑色 128G 官方标配 优惠套装1 一年碎屏保499', NULL, 225, 20, '', '小米12 Pro 222 黑色 128G 官方标配 优惠套装1 一年碎屏保499', '5000万高清', 5399.0000, 0);
INSERT INTO `pms_sku_info` VALUES (13, 10, '小米12 Pro 222 土豪金 128G 官方标配 优惠套装1 一年碎屏保499', NULL, 225, 20, '', '小米12 Pro 222 土豪金 128G 官方标配 优惠套装1 一年碎屏保499', '5000万高清', 5399.0000, 0);
INSERT INTO `pms_sku_info` VALUES (14, 11, '小米2 111 土豪金 128G 官方标配 优惠套装1 一年碎屏保499', NULL, 225, 20, 'https://msb-mall-zyh2.oss-cn-shanghai.aliyuncs.com/2025-11-26//a9a3d754-779e-4145-8641-50ecd6a583ce_QQ浏览器截图20241209170221.png', '小米2 111 土豪金 128G 官方标配 优惠套装1 一年碎屏保499', '3232', 1299.0000, 0);
INSERT INTO `pms_sku_info` VALUES (15, 12, '小米 X 111 黑色 256G 官方标配 优惠套装2 一年碎屏保499', NULL, 225, 20, 'https://msb-mall-zyh2.oss-cn-shanghai.aliyuncs.com/2025-12-04//903c8e1c-1fda-4423-8775-86bc8153fa44_QQ浏览器截图20241209171153.png', '小米 X 111 黑色 256G 官方标配 优惠套装2 一年碎屏保499', 'XXXXXX', 20000.0000, 0);
INSERT INTO `pms_sku_info` VALUES (16, 13, '华为 洒洒水 啊洒洒水 土豪金 256G 官方标配 优惠套装1 一年碎屏保499', NULL, 225, 19, '', '华为 洒洒水 啊洒洒水 土豪金 256G 官方标配 优惠套装1 一年碎屏保499', '112121', 1111111.0000, 0);
INSERT INTO `pms_sku_info` VALUES (17, 14, '华为 S啊AAASA 111 土豪金 128G 官方标配 优惠套装2 一年碎屏保499', NULL, 225, 19, 'https://msb-mall-zyh2.oss-cn-shanghai.aliyuncs.com/2025-12-04//15d6f03b-b7b7-4758-891e-6fe10f2e9a18_QQ浏览器截图20241209170221.png', '华为 S啊AAASA 111 土豪金 128G 官方标配 优惠套装2 一年碎屏保499', '455454', 2000.0000, 0);
INSERT INTO `pms_sku_info` VALUES (18, 15, '华为谷雨 111 土豪金 128G 官方标配 优惠套装2 一年碎屏保499', NULL, 225, 19, 'https://msb-mall-zyh2.oss-cn-shanghai.aliyuncs.com/2025-12-04//f4b4ce33-e470-4275-80b8-5a6f116dcb8e_QQ浏览器截图20241209170221.png', '华为谷雨 111 土豪金 128G 官方标配 优惠套装2 一年碎屏保499', '7000', 7000.0000, 0);
...
CREATE TABLE `pms_sku_sale_attr_value`  (
  ...
  `attr_sort` int(11) NULL DEFAULT NULL COMMENT '˳?',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 79 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_unicode_ci COMMENT = 'sku????????&ֵ' ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of pms_sku_sale_attr_value
-- ----------------------------
INSERT INTO `pms_sku_sale_attr_value` VALUES (1, 6, 5, '尺寸', '111', NULL);
INSERT INTO `pms_sku_sale_attr_value` VALUES (2, 6, 7, '选择颜色', '土豪金', NULL);
INSERT INTO `pms_sku_sale_attr_value` VALUES (3, 6, 29, '选择版本', '512G', NULL);
INSERT INTO `pms_sku_sale_attr_value` VALUES (4, 6, 30, '购买方式', '官方标配', NULL);
INSERT INTO `pms_sku_sale_attr_value` VALUES (5, 6, 31, '套装', '优惠套装1', NULL);
INSERT INTO `pms_sku_sale_attr_value` VALUES (6, 6, 32, '原厂服务', '一年碎屏保499', NULL);
INSERT INTO `pms_sku_sale_attr_value` VALUES (7, 7, 5, '尺寸', '111', NULL);
INSERT INTO `pms_sku_sale_attr_value` VALUES (8, 7, 7, '选择颜色', '土豪金', NULL);
INSERT INTO `pms_sku_sale_attr_value` VALUES (9, 7, 29, '选择版本', '256G', NULL);
INSERT INTO `pms_sku_sale_attr_value` VALUES (10, 7, 30, '购买方式', '官方标配', NULL);
INSERT INTO `pms_sku_sale_attr_value` VALUES (11, 7, 31, '套装', '优惠套装1', NULL);
INSERT INTO `pms_sku_sale_attr_value` VALUES (12, 7, 32, '原厂服务', '一年碎屏保499', NULL);
INSERT INTO `pms_sku_sale_attr_value` VALUES (13, 8, 5, '尺寸', '111', NULL);
INSERT INTO `pms_sku_sale_attr_value` VALUES (14, 8, 7, '选择颜色', '黑色', NULL);
INSERT INTO `pms_sku_sale_attr_value` VALUES (15, 8, 29, '选择版本', '512G', NULL);
INSERT INTO `pms_sku_sale_attr_value` VALUES (16, 8, 30, '购买方式', '官方标配', NULL);
INSERT INTO `pms_sku_sale_attr_value` VALUES (17, 8, 31, '套装', '优惠套装1', NULL);
INSERT INTO `pms_sku_sale_attr_value` VALUES (18, 8, 32, '原厂服务', '一年碎屏保499', NULL);
INSERT INTO `pms_sku_sale_attr_value` VALUES (19, 9, 5, '尺寸', '111', NULL);
INSERT INTO `pms_sku_sale_attr_value` VALUES (20, 9, 7, '选择颜色', '黑色', NULL);
INSERT INTO `pms_sku_sale_attr_value` VALUES (21, 9, 29, '选择版本', '256G', NULL);
INSERT INTO `pms_sku_sale_attr_value` VALUES (22, 9, 30, '购买方式', '官方标配', NULL);
INSERT INTO `pms_sku_sale_attr_value` VALUES (23, 9, 31, '套装', '优惠套装1', NULL);
INSERT INTO `pms_sku_sale_attr_value` VALUES (24, 9, 32, '原厂服务', '一年碎屏保499', NULL);
INSERT INTO `pms_sku_sale_attr_value` VALUES (25, 10, 5, '尺寸', '111', NULL);
INSERT INTO `pms_sku_sale_attr_value` VALUES (26, 10, 7, '选择颜色', '绿色', NULL);
INSERT INTO `pms_sku_sale_attr_value` VALUES (27, 10, 29, '选择版本', '512G', NULL);
INSERT INTO `pms_sku_sale_attr_value` VALUES (28, 10, 30, '购买方式', '官方标配', NULL);
INSERT INTO `pms_sku_sale_attr_value` VALUES (29, 10, 31, '套装', '优惠套装1', NULL);
INSERT INTO `pms_sku_sale_attr_value` VALUES (30, 10, 32, '原厂服务', '一年碎屏保499', NULL);
INSERT INTO `pms_sku_sale_attr_value` VALUES (31, 11, 5, '尺寸', '111', NULL);
INSERT INTO `pms_sku_sale_attr_value` VALUES (32, 11, 7, '选择颜色', '绿色', NULL);
INSERT INTO `pms_sku_sale_attr_value` VALUES (33, 11, 29, '选择版本', '256G', NULL);
INSERT INTO `pms_sku_sale_attr_value` VALUES (34, 11, 30, '购买方式', '官方标配', NULL);
INSERT INTO `pms_sku_sale_attr_value` VALUES (35, 11, 31, '套装', '优惠套装1', NULL);
INSERT INTO `pms_sku_sale_attr_value` VALUES (36, 11, 32, '原厂服务', '一年碎屏保499', NULL);
INSERT INTO `pms_sku_sale_attr_value` VALUES (37, 12, 5, '尺寸', '222', NULL);
INSERT INTO `pms_sku_sale_attr_value` VALUES (38, 12, 7, '选择颜色', '黑色', NULL);
INSERT INTO `pms_sku_sale_attr_value` VALUES (39, 12, 29, '选择版本', '128G', NULL);
INSERT INTO `pms_sku_sale_attr_value` VALUES (40, 12, 30, '购买方式', '官方标配', NULL);
INSERT INTO `pms_sku_sale_attr_value` VALUES (41, 12, 31, '套装', '优惠套装1', NULL);
INSERT INTO `pms_sku_sale_attr_value` VALUES (42, 12, 32, '原厂服务', '一年碎屏保499', NULL);
INSERT INTO `pms_sku_sale_attr_value` VALUES (43, 13, 5, '尺寸', '222', NULL);
INSERT INTO `pms_sku_sale_attr_value` VALUES (44, 13, 7, '选择颜色', '土豪金', NULL);
INSERT INTO `pms_sku_sale_attr_value` VALUES (45, 13, 29, '选择版本', '128G', NULL);
INSERT INTO `pms_sku_sale_attr_value` VALUES (46, 13, 30, '购买方式', '官方标配', NULL);
INSERT INTO `pms_sku_sale_attr_value` VALUES (47, 13, 31, '套装', '优惠套装1', NULL);
INSERT INTO `pms_sku_sale_attr_value` VALUES (48, 13, 32, '原厂服务', '一年碎屏保499', NULL);
INSERT INTO `pms_sku_sale_attr_value` VALUES (49, 14, 5, '尺寸', '111', NULL);
INSERT INTO `pms_sku_sale_attr_value` VALUES (50, 14, 7, '选择颜色', '土豪金', NULL);
INSERT INTO `pms_sku_sale_attr_value` VALUES (51, 14, 29, '选择版本', '128G', NULL);
INSERT INTO `pms_sku_sale_attr_value` VALUES (52, 14, 30, '购买方式', '官方标配', NULL);
INSERT INTO `pms_sku_sale_attr_value` VALUES (53, 14, 31, '套装', '优惠套装1', NULL);
INSERT INTO `pms_sku_sale_attr_value` VALUES (54, 14, 32, '原厂服务', '一年碎屏保499', NULL);
INSERT INTO `pms_sku_sale_attr_value` VALUES (55, 15, 5, '尺寸', '111', NULL);
INSERT INTO `pms_sku_sale_attr_value` VALUES (56, 15, 7, '选择颜色', '黑色', NULL);
INSERT INTO `pms_sku_sale_attr_value` VALUES (57, 15, 29, '选择版本', '256G', NULL);
INSERT INTO `pms_sku_sale_attr_value` VALUES (58, 15, 30, '购买方式', '官方标配', NULL);
INSERT INTO `pms_sku_sale_attr_value` VALUES (59, 15, 31, '套装', '优惠套装2', NULL);
INSERT INTO `pms_sku_sale_attr_value` VALUES (60, 15, 32, '原厂服务', '一年碎屏保499', NULL);
INSERT INTO `pms_sku_sale_attr_value` VALUES (61, 16, 5, '尺寸', '啊洒洒水', NULL);
INSERT INTO `pms_sku_sale_attr_value` VALUES (62, 16, 7, '选择颜色', '土豪金', NULL);
INSERT INTO `pms_sku_sale_attr_value` VALUES (63, 16, 29, '选择版本', '256G', NULL);
INSERT INTO `pms_sku_sale_attr_value` VALUES (64, 16, 30, '购买方式', '官方标配', NULL);
INSERT INTO `pms_sku_sale_attr_value` VALUES (65, 16, 31, '套装', '优惠套装1', NULL);
INSERT INTO `pms_sku_sale_attr_value` VALUES (66, 16, 32, '原厂服务', '一年碎屏保499', NULL);
INSERT INTO `pms_sku_sale_attr_value` VALUES (67, 17, 5, '尺寸', '111', NULL);
INSERT INTO `pms_sku_sale_attr_value` VALUES (68, 17, 7, '选择颜色', '土豪金', NULL);
INSERT INTO `pms_sku_sale_attr_value` VALUES (69, 17, 29, '选择版本', '128G', NULL);
INSERT INTO `pms_sku_sale_attr_value` VALUES (70, 17, 30, '购买方式', '官方标配', NULL);
INSERT INTO `pms_sku_sale_attr_value` VALUES (71, 17, 31, '套装', '优惠套装2', NULL);
INSERT INTO `pms_sku_sale_attr_value` VALUES (72, 17, 32, '原厂服务', '一年碎屏保499', NULL);
INSERT INTO `pms_sku_sale_attr_value` VALUES (73, 18, 5, '尺寸', '111', NULL);
INSERT INTO `pms_sku_sale_attr_value` VALUES (74, 18, 7, '选择颜色', '土豪金', NULL);
INSERT INTO `pms_sku_sale_attr_value` VALUES (75, 18, 29, '选择版本', '128G', NULL);
INSERT INTO `pms_sku_sale_attr_value` VALUES (76, 18, 30, '购买方式', '官方标配', NULL);
INSERT INTO `pms_sku_sale_attr_value` VALUES (77, 18, 31, '套装', '优惠套装2', NULL);
INSERT INTO `pms_sku_sale_attr_value` VALUES (78, 18, 32, '原厂服务', '一年碎屏保499', NULL);
...
CREATE TABLE `pms_spu_comment`  (
  ...
  `spu_name` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL DEFAULT NULL COMMENT '??Ʒ???',
  `member_nick_name` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL DEFAULT NULL COMMENT '??Ա?ǳ',
  `star` tinyint(1) NULL DEFAULT NULL COMMENT '?Ǽ?',
  `member_ip` varchar(64) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL DEFAULT NULL COMMENT '??Աip',
  `create_time` datetime NULL DEFAULT NULL COMMENT '????ʱ?',
  `show_status` tinyint(1) NULL DEFAULT NULL COMMENT '??ʾ״̬[0-????ʾ??1-??ʾ]',
  `spu_attributes` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL DEFAULT NULL COMMENT '????ʱ???????',
  `likes_count` int(11) NULL DEFAULT NULL COMMENT '??????',
  `reply_count` int(11) NULL DEFAULT NULL COMMENT '?ظ???',
  `resources` varchar(1000) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL DEFAULT NULL COMMENT '????ͼƬ/??Ƶ[json???ݣ?[{type:?ļ?????,url:??Դ·??}]]',
  `content` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL COMMENT '???',
  `member_icon` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL DEFAULT NULL COMMENT '?û?ͷ?',
  `comment_type` tinyint(4) NULL DEFAULT NULL COMMENT '????????[0 - ????Ʒ??ֱ?????ۣ?1 - ?????۵Ļظ?]',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 1 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_unicode_ci COMMENT = '??Ʒ???' ROW_FORMAT = Dynamic;
...
CREATE TABLE `pms_spu_images`  (
  `id` bigint(20) NOT NULL AUTO_INCREMENT COMMENT 'id',
  `spu_id` bigint(20) NULL DEFAULT NULL COMMENT 'spu_id',
  `img_name` varchar(200) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL DEFAULT NULL COMMENT 'ͼƬ??',
  `img_url` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL DEFAULT NULL COMMENT 'ͼƬ??ַ',
  `img_sort` int(11) NULL DEFAULT NULL COMMENT '˳?',
  `default_img` tinyint(4) NULL DEFAULT NULL COMMENT '?Ƿ?Ĭ??ͼ',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 16 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_unicode_ci COMMENT = 'spuͼƬ' ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of pms_spu_images
-- ----------------------------
INSERT INTO `pms_spu_images` VALUES (6, 7, NULL, 'https://msb-mall-zyh2.oss-cn-shanghai.aliyuncs.com/2025-11-26//af2815f3-1094-4722-8ac0-6e1224029c23_QQ浏览器截图20241209170221.png', NULL, NULL);
INSERT INTO `pms_spu_images` VALUES (7, 10, NULL, 'https://msb-mall-zyh2.oss-cn-shanghai.aliyuncs.com/2025-11-26//d2439296-3f41-444b-830e-11399d2ca3a9_QQ浏览器截图20241209171153.png', NULL, NULL);
INSERT INTO `pms_spu_images` VALUES (8, 10, NULL, 'https://msb-mall-zyh2.oss-cn-shanghai.aliyuncs.com/2025-11-26//5b50b9db-e98a-4614-8c87-4ea8d98000d3_QQ浏览器截图20241209170221.png', NULL, NULL);
INSERT INTO `pms_spu_images` VALUES (9, 11, NULL, 'https://msb-mall-zyh2.oss-cn-shanghai.aliyuncs.com/2025-11-26//a9a3d754-779e-4145-8641-50ecd6a583ce_QQ浏览器截图20241209170221.png', NULL, NULL);
INSERT INTO `pms_spu_images` VALUES (10, 11, NULL, 'https://msb-mall-zyh2.oss-cn-shanghai.aliyuncs.com/2025-11-26//f335a6e8-0af3-46a4-8d69-3df4ca9c181f_QQ浏览器截图20241209171346.png', NULL, NULL);
INSERT INTO `pms_spu_images` VALUES (11, 12, NULL, 'https://msb-mall-zyh2.oss-cn-shanghai.aliyuncs.com/2025-12-04//903c8e1c-1fda-4423-8775-86bc8153fa44_QQ浏览器截图20241209171153.png', NULL, NULL);
INSERT INTO `pms_spu_images` VALUES (12, 12, NULL, 'https://msb-mall-zyh2.oss-cn-shanghai.aliyuncs.com/2025-12-04//4e0166c2-3321-4798-866e-68f1546315f5_QQ浏览器截图20241209171250.png', NULL, NULL);
INSERT INTO `pms_spu_images` VALUES (13, 13, NULL, 'https://msb-mall-zyh2.oss-cn-shanghai.aliyuncs.com/2025-12-04//e8adbcfa-2484-4a7a-8a07-8141c760f3e8_QQ浏览器截图20241209170221.png', NULL, NULL);
INSERT INTO `pms_spu_images` VALUES (14, 14, NULL, 'https://msb-mall-zyh2.oss-cn-shanghai.aliyuncs.com/2025-12-04//15d6f03b-b7b7-4758-891e-6fe10f2e9a18_QQ浏览器截图20241209170221.png', NULL, NULL);
INSERT INTO `pms_spu_images` VALUES (15, 15, NULL, 'https://msb-mall-zyh2.oss-cn-shanghai.aliyuncs.com/2025-12-04//f4b4ce33-e470-4275-80b8-5a6f116dcb8e_QQ浏览器截图20241209170221.png', NULL, NULL);
...
CREATE TABLE `pms_spu_info`  (
  ...
  `spu_name` varchar(200) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL DEFAULT NULL COMMENT '??Ʒ???',
  `spu_description` varchar(1000) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL DEFAULT NULL COMMENT '??Ʒ????',
  `catalog_id` bigint(20) NULL DEFAULT NULL COMMENT '????????id',
  `brand_id` bigint(20) NULL DEFAULT NULL COMMENT 'Ʒ??id',
  `weight` decimal(18, 4) NULL DEFAULT NULL,
  `publish_status` tinyint(4) NULL DEFAULT NULL COMMENT '?ϼ?״̬[0 - ?¼ܣ?1 - ?ϼ?]',
  `create_time` datetime NULL DEFAULT NULL,
  `update_time` datetime NULL DEFAULT NULL,
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 16 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_unicode_ci COMMENT = 'spu??Ϣ' ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of pms_spu_info
-- ----------------------------
INSERT INTO `pms_spu_info` VALUES (7, '华为 MATE', '华为 MATE', 225, 19, 200.0000, 1, '2025-11-26 15:22:01', '2025-11-29 16:28:42');
INSERT INTO `pms_spu_info` VALUES (10, '小米12 Pro', '小米12 Pro 晓龙8', 225, 20, 5.0000, 1, '2025-11-26 16:20:04', '2025-12-03 16:25:37');
INSERT INTO `pms_spu_info` VALUES (11, '小米2', '小米2', 225, 20, 0.6000, 1, '2025-11-26 17:51:18', '2025-12-03 16:40:39');
INSERT INTO `pms_spu_info` VALUES (12, '小米 X', '小米X', 225, 20, 0.5000, 1, '2025-12-04 00:20:37', '2025-12-03 16:23:21');
INSERT INTO `pms_spu_info` VALUES (13, '华为 洒洒水', '阿萨啊', 225, 19, 0.5000, 1, '2025-12-04 00:46:38', '2025-12-03 16:46:44');
INSERT INTO `pms_spu_info` VALUES (14, '华为 S啊AAASA', 'ASASASAS', 225, 19, 0.6000, 1, '2025-12-04 00:55:15', '2025-12-03 16:55:26');
INSERT INTO `pms_spu_info` VALUES (15, '华为谷雨', 'SSSSS', 225, 19, 0.5000, 1, '2025-12-04 01:04:29', '2025-12-03 17:05:31');
...
CREATE TABLE `pms_spu_info_desc`  (
  `spu_id` bigint(20) NOT NULL COMMENT '??Ʒid',
  `decript` longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL COMMENT '??Ʒ???',
  PRIMARY KEY (`spu_id`) USING BTREE
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_unicode_ci COMMENT = 'spu??Ϣ???' ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of pms_spu_info_desc
-- ----------------------------
INSERT INTO `pms_spu_info_desc` VALUES (7, 'https://msb-mall-zyh2.oss-cn-shanghai.aliyuncs.com/2025-11-26//d292dd79-9124-45f7-8897-c22c7b23f0ee_QQ浏览器截图20241209170221.png');
INSERT INTO `pms_spu_info_desc` VALUES (10, 'https://msb-mall-zyh2.oss-cn-shanghai.aliyuncs.com/2025-11-26//90eb52dc-e1e5-4d03-8e40-fd4f91e8ab7c_QQ浏览器截图20241209171153.png,https://msb-mall-zyh2.oss-cn-shanghai.aliyuncs.com/2025-11-26//30b4e788-caa6-452b-8c6c-08be8a6106eb_QQ浏览器截图20241209170221.png');
INSERT INTO `pms_spu_info_desc` VALUES (11, 'https://msb-mall-zyh2.oss-cn-shanghai.aliyuncs.com/2025-11-26//697dc798-b3ba-4f0f-88c3-5e13c92f00c9_QQ浏览器截图20241209170221.png,https://msb-mall-zyh2.oss-cn-shanghai.aliyuncs.com/2025-11-26//98a32926-b9e4-45a6-82f8-fcd7bc2b8a7a_QQ浏览器截图20241209170221.png');
INSERT INTO `pms_spu_info_desc` VALUES (12, 'https://msb-mall-zyh2.oss-cn-shanghai.aliyuncs.com/2025-12-04//a44bc5a0-149b-4868-836d-44374cbc1876_QQ浏览器截图20241209170221.png');
INSERT INTO `pms_spu_info_desc` VALUES (13, 'https://msb-mall-zyh2.oss-cn-shanghai.aliyuncs.com/2025-12-04//cf49233c-eab7-4455-8c93-4cb0815ff024_QQ浏览器截图20241209170221.png');
INSERT INTO `pms_spu_info_desc` VALUES (14, 'https://msb-mall-zyh2.oss-cn-shanghai.aliyuncs.com/2025-12-04//9a3a4410-88e2-4216-8eed-7d9b741ba360_QQ浏览器截图20241209170221.png');
INSERT INTO `pms_spu_info_desc` VALUES (15, 'https://msb-mall-zyh2.oss-cn-shanghai.aliyuncs.com/2025-12-04//f5a25229-46d0-4c90-8d33-c8680e2f2d1d_QQ浏览器截图20241209170221.png');
